...
class CarElectrician extends StatefulWidget {
  const CarElectrician({super.key});

  @override
  State<CarElectrician> createState() => _PopularCardState();
}

class _PopularCardState extends State<CarElectrician> {
  @override
  Widget build(BuildContext context) {
    return StreamBuilder(
        stream: FirebaseFirestore.instance
            .collection('users_more_info')
            .where("skill", whereIn: ['Car Electricians']).snapshots(),
