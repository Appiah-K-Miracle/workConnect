...
class CarSprayer extends StatefulWidget {
  const CarSprayer({super.key});

  @override
  State<CarSprayer> createState() => _PopularCardState();
}

class _PopularCardState extends State<CarSprayer> {
  @override
  Widget build(BuildContext context) {
    return StreamBuilder(
        stream: FirebaseFirestore.instance
            .collection('users_more_info')
            .where("skill", whereIn: ['Car Sprayer']).snapshots(),
