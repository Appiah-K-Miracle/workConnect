...
class HouseKeeper extends StatefulWidget {
  const HouseKeeper({super.key});

  @override
  State<HouseKeeper> createState() => _PopularCardState();
}

class _PopularCardState extends State<HouseKeeper> {
  @override
  Widget build(BuildContext context) {
    return StreamBuilder(
        stream: FirebaseFirestore.instance
            .collection('users_more_info')
            .where("skill", whereIn: ['House Keeper']).snapshots(),
