...
class Manson extends StatefulWidget {
  const Manson({super.key});

  @override
  State<Manson> createState() => _PopularCardState();
}

class _PopularCardState extends State<Manson> {
  @override
  Widget build(BuildContext context) {
    return StreamBuilder(
        stream: FirebaseFirestore.instance
            .collection('users_more_info')
            .where("skill", whereIn: ['Manson']).snapshots(),
