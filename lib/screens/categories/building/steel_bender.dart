...
class Steel_Bender extends StatefulWidget {
  const Steel_Bender({super.key});

  @override
  State<Steel_Bender> createState() => _PopularCardState();
}

class _PopularCardState extends State<Steel_Bender> {
  @override
  Widget build(BuildContext context) {
    return StreamBuilder(
        stream: FirebaseFirestore.instance
            .collection('users_more_info')
            .where("skill", whereIn: ['Steel Bender']).snapshots(),
